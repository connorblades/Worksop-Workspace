...
| `/membership` | *"Flexible access. Honest pricing. No contracts."* | Reads like a tagline, not an answer. The query is "how much does it cost" — answer it immediately | *"Worksop Workspace pricing: £12 per day, £30 per week (hot desk), £50 per week (dedicated desk from Phase 2), from £125 per week (private office), £30 per hour (meeting room), £40 per hour (studio, Phase 3). All rolling weekly, no long contracts, no setup fee."* |
