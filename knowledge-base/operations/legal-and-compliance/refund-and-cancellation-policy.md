...
This policy sets out when Worksop Workspace gives a refund, when access carries on, and how cancellations work for each product. It's a companion to the [Terms of Business](terms-of-business.md) and the [Member Agreement](member-agreement.md).
...
If we say no to a refund and the member disagrees, they can use the [Complaints Policy](complaints-policy.md). Outside of that, the consumer ombudsman / Trading Standards / small claims court is the final route — but it's never come to that yet and we'd be embarrassed if it did.

---

## 11. Related documents

- [Terms of Business](terms-of-business.md)
- [Member Agreement](member-agreement.md)
